PROMPTS = {
    "an_ninh_nhan_dan": (
        ...
        "Áo phải có túi ngực vuông, cấp hiệu đeo vai màu đỏ, và bảng tên/phù hiệu gắn trên ngực phải, tên hiển thị DREAM chữ in hoa không dấu, số hiệu là 123-456."
        "Thêm mũ kê-pi màu sẫm màu giống màu quần nói trên quần và huy hiệu công an ở giữa, đội vừa vặn và tự nhiên trên đầu, không bị bồng bềnh hay quá khổ. "
    ...
    "canh_sat_co_dong": (
        ...
        "Ảnh chụp RAW DSLR siêu thực, độ phân giải 4K, ánh sáng tự nhiên."
        "Tuyệt đối bắt buộc phải sao chép y hệt và giữ đúng 100% chi tiết biển tên, quân hàm, logo, 2 logo ở cổ áo, và trang phục từ hình ảnh tham khảo. "
        "Tuyệt đối giữ nguyên bản 100% khuôn mặt, danh tính, biểu cảm, cơ thể, vóc dáng và tư thế từ ảnh gốc của người dùng. Nghiêm cấm làm thay đổi khuôn mặt, tuyệt đối không lấy khuôn mặt từ ảnh tham khảo trang phục. "
        "Chỉ thay đổi quần áo thành đồng phục chiến thuật chuẩn của Cảnh sát Cơ động Việt Nam"
        "đồng phục chiến thuật màu xanh đen đậm với túi ngực, và bắt buộc phải có 2 logo (phù hiệu) gắn ở 2 bên cổ áo (logo như hình tham khảo và có 1 đường kẻ dọc vàng chạy qua)."
        "Thêm mũ bảo hiểm chiến thuật màu xanh đen đậm hoặc mũ nồi có logo bên tay trái. "
        "Bối cảnh: ngoài trời"
    ),
    "canh_sat_dac_nhiem": (
    ...
    "canh_sat_giao_thong": (
        ...
        "Ảnh chụp RAW DSLR siêu thực, độ phân giải 4K, ánh sáng tự nhiên."
        "Tuyệt đối bắt buộc phải sao chép y hệt và giữ đúng 100% những chi tiết biển tên, quân hàm, logo và trang phục từ hình ảnh tham khảo."
        "Tuyệt đối giữ nguyên bản 100% khuôn mặt, danh tính, biểu cảm, cơ thể, vóc dáng và tư thế từ ảnh gốc của người dùng. Nghiêm cấm làm thay đổi khuôn mặt, tuyệt đối không lấy khuôn mặt từ ảnh tham khảo trang phục. "
        "Chỉ thay đổi quần áo thành đồng phục chuẩn của Cảnh sát Giao thông Việt Nam"
        "Áo màu vàng lúa chín đặc trưng với túi ngực, biển tên gắn trên ngực phải, tên hiển thị DREAM chữ in hoa không dấu, số hiệu là 123-456."
        "Thêm mũ kê-pi màu vàng có viền đỏ và huy hiệu công an ở giữa."
        "Bối cảnh: ngoài trời"
    ),
    "canh_sat_nhan_dan": (
        ...
        "Thêm mũ kê-pi màu xanh mạ non có viền đỏ và huy hiệu công an ở giữa, quần áo và mũ giống màu nhau."
        "Bối cảnh: ngoài trời"
    ),
    "canh_sat_pccc": (
...
NEGATIVE_PROMPT = (
    "khác danh tính, khuôn mặt khác, thay đổi đặc điểm khuôn mặt, khuôn mặt biến dạng, biến dạng danh tính, lấy khuôn mặt từ ảnh tham khảo, thay đổi kiểu tóc, "
    "thay đổi vóc dáng cơ thể, thay đổi tuổi, thay đổi giới tính, thay đổi sắc tộc, "
